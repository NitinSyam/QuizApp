document.addEventListener('DOMContentLoaded', () => {
    ...
    function selectAnswer(selectedButton, correctAnswer, answers) {
        ...
        let scoreForThisQuestion = Math.max(baseScorePerQuestion - Math.floor(timeTaken) * penaltyPerQuestion, 0);
        ...
        if (decodeHTML(selectedButton.innerHTML) === decodeHTML(correctAnswer)) {
            ...
            resultContainer.innerText = `Wrong!! The correct answer is: ${decodeHTML(correctAnswer)}`;
        }
